...
import { AVAILABLE_DELIVERY_DATE, AVAILABLE_PAYMENT_METHOD, DEFAULT_PAYEMENT_METHOD } from '@/lib/constants'
...
const CheckoutForm = () => {
    ...
    const {
        cart: {
            ...
            shippingAddress,
            deliveryDateIndex,
            paymentMethod = DEFAULT_PAYEMENT_METHOD,
        },
        setShippingAddress,
        setPaymentMethod,
        updateItem,
    ...
    const handlePlaceOrder = async () => {
        const res = await createOrder({
            ...
            expectedDeliveryDate: calculateFutureDate(
                AVAILABLE_DELIVERY_DATE[deliveryDateIndex!].daysToDeliver
            ),
            deliveryDateIndex,
            paymentMethod,
            itemsPrice,
            ...
            <CardContent className='p-4'>
                ...
                {isPaymentMethodSelected && isAddressSelected && (
                    <div>
                        ...
                        <p className='text-xs text-center py-2'>
                            By placing your order, you agree to NextBuy&apos;s{' '}
                                ...
                                <div className='col-span-5'>
                                    <p>
                                        Delivery date:{' '}
                                        {
                                            formatDateTime(
                                                calculateFutureDate(
                                                    AVAILABLE_DELIVERY_DATE[deliveryDateIndex]
                                                        .daysToDeliver
                                                )
                                            ).dateOnly
                                        }
                                            ...
                                            <div>
                                                <div className=' font-bold'>
                                                    ...
                                                    <ul>
                                                        <RadioGroup
                                                            value={
                                                                AVAILABLE_DELIVERY_DATE[deliveryDateIndex!].name
                                                            }
                                                            onValueChange={(value) =>
                                                                setDeliveryDateIndex(
                                                                    AVAILABLE_DELIVERY_DATE.findIndex(
                                                                        (address) => address.name === value
                                                                    )!
                                                                )
                                                            }
                                                        >
                                                            {AVAILABLE_DELIVERY_DATE.map((dd) => (
